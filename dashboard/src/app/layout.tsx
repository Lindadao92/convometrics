        ...
        <div className="flex min-h-screen">
          <aside className="w-56 shrink-0 border-r border-white/[0.06] bg-[#0a0b10] flex flex-col">
            ...
            <nav className="flex flex-col gap-1 px-3 mt-2">
              <a
                href="/"
                className="flex items-center gap-3 rounded-lg bg-white/[0.06] px-3 py-2 text-sm font-medium text-white"
              >
              ...
              <a
                href="/conversations"
                className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm text-zinc-400 hover:text-white hover:bg-white/[0.04] transition-colors"
              >
